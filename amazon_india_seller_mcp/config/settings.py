...
class Settings(BaseSettings):
    ...
    def browser_selectors(self) -> dict[str, dict[str, str]]:
        ...
        if not self.browser_selectors_path:
            return {}
        try:
            from amazon_india_seller_mcp.services.security import validate_config_path  # noqa: PLC0415
...
def configure_logging(settings: Settings | None = None) -> None:
    ...
    from amazon_india_seller_mcp.services.security import install_log_redaction  # noqa: PLC0415 - avoids an import cycle
